...
def contact():
    ...
    st.write("Created By Muhammad Musaddiq, Maooz Bin Abdul Moid And Anas Jamal")
    st.write("If you want to contact us then, kindly do it on the email given below:")
    st.write("Gmail: muhammadmusaddiq49@gmail.com")
    st.write("Gmail: maoozmoid@gmail.com")
    st.write("Gmail: anasbangash85@gmail.com")
